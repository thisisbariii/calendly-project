        ...
        <>
            <section className="dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <p className="mt-4 mb-8 dark:text-black">Not seeing what you are looking for? <br />Go to  <a href="#" className=' text-blue-500 hover:underline font-bold"'>help center </a> </p>
